...
You are starting the **Power BI AI Developer** workflow using the `@powerbi-AI-developer` custom agent.
...
10. Use MCP tools (`microsoft_docs_search`, `microsoft_docs_fetch`, `microsoft_code_sample_search`) to verify TMDL and DAX syntax before generating code.
