...
description: >-
  Use when analyzing functional specifications to extract KPIs, dimensions, grain, and constraints.
  Triggers: "analyze requirements", "extract KPIs", "analyze specification",
  "requirements summary", "identify dimensions", "define grain",
  "business requirements", "functional spec analysis", "clarification questions".
user-invocable: true
---
...
| | |
|---|---|
| **Input** | Functional specification document (`.md` or pasted text) |
| **Output** | `<ProjectName>/spec/requirements_summary.md` |
