...
Rectangle shape with text overlay for styled backgrounds.
...
```
Position:  x: 0, y: 0
Size:      width: page width, height: 72px
...
[{
  "textRuns": [{
    "value": "Title Text",
    "textStyle": {"fontSize": "24pt", "fontWeight": "bold", "fontColor": "#333333"}
  }]
}]
```
...
For title textboxes, disable container properties:
