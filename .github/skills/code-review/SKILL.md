...
name: code-review
description: >-
  Use when validating TMDL quality, DAX BPA compliance, schema consistency, or naming conventions.
  Triggers: "review TMDL", "check BPA compliance", "validate model quality", "code review",
  "check naming conventions", "find schema issues", "validate relationships",
  "check summarizeBy", "review model structure", "quality gate".
user-invocable: true
---
...
1. **Read** `.github/skills/physical-model-tmdl/references/tmdl-syntax-reference.md` for syntax validation rules.
...
**Prerequisites**:
- [ ] Read `.github/skills/code-review/references/bpa-rules-reference.md` (all 27+ rules)
